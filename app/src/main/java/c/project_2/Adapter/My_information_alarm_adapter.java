...
import c.project_2.Model.Alarm_Information;
...
public class My_information_alarm_adapter extends RecyclerView.Adapter<My_information_alarm_adapter.MY_INFO_ViewHolder> {
    ...
    @Override
    public MY_INFO_ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(MY_INFO_ViewHolder holder, int position) {
